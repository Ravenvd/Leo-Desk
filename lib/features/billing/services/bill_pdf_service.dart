    ...
    document.addPage(pw.MultiPage(
      ...
      build: (_) => [
        ...
        pw.Row(mainAxisAlignment: pw.MainAxisAlignment.spaceBetween, children: [
          pw.Text('BILL', style: pw.TextStyle(fontSize: 20, fontWeight: pw.FontWeight.bold)),
        ...
        pw.Align(
          ...
          child: pw.SizedBox(width: 250, child: pw.Column(children: [
            _row('Subtotal', bill.subtotalPaise),
            if (bill.discountPaise != 0) _row('Discount', bill.discountPaise),
        ...
        pw.Center(child: pw.Text('Thank you for your business.', style: pw.TextStyle(fontStyle: pw.FontStyle.italic, fontSize: 10))),
      ],
    ));
    return document.save();
  }

  static pw.Widget _row(String label, int paise, {bool bold = false}) => pw.Padding(
